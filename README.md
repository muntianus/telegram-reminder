...
- Добавлены шаблоны Issues для багов и feature-запросов.
- Добавлен шаблон Pull Request с чеклистом для быстрых ревью.
- Отключено создание пустых Issues без шаблона.
