...
func TestCryptoDigestCommand(t *testing.T) {
	...
	bot.Handle("/crypto", func(c tb.Context) error {
		...
		text, err := botpkg.SystemCompletion(ctx, client, botpkg.CryptoDigestPrompt, "gpt-4.1")
		if err != nil {
...
func TestTechDigestCommand(t *testing.T) {
	...
	bot.Handle("/tech", func(c tb.Context) error {
		...
		text, err := botpkg.SystemCompletion(ctx, client, botpkg.TechDigestPrompt, "gpt-4.1")
		if err != nil {
			return c.Send("OpenAI error")
		}
		return c.Send(text)
...
func TestRealEstateDigestCommand(t *testing.T) {
	...
	bot.Handle("/realestate", func(c tb.Context) error {
		...
		text, err := botpkg.SystemCompletion(ctx, client, botpkg.RealEstateDigestPrompt, "gpt-4.1")
		if err != nil {
			return c.Send("OpenAI error")
		}
		return c.Send(text)
...
func TestBusinessDigestCommand(t *testing.T) {
	...
	bot.Handle("/business", func(c tb.Context) error {
		...
		text, err := botpkg.SystemCompletion(ctx, client, botpkg.BusinessDigestPrompt, "gpt-4.1")
		if err != nil {
			return c.Send("OpenAI error")
		}
		return c.Send(text)
...
func TestInvestmentDigestCommand(t *testing.T) {
	...
	bot.Handle("/investment", func(c tb.Context) error {
		...
		text, err := botpkg.SystemCompletion(ctx, client, botpkg.InvestmentDigestPrompt, "gpt-4.1")
		if err != nil {
			return c.Send("OpenAI error")
		}
		return c.Send(text)
...
func TestStartupDigestCommand(t *testing.T) {
	...
	bot.Handle("/startup", func(c tb.Context) error {
		...
		text, err := botpkg.SystemCompletion(ctx, client, botpkg.StartupDigestPrompt, "gpt-4.1")
		if err != nil {
			return c.Send("OpenAI error")
		}
		return c.Send(text)
...
func TestGlobalDigestCommand(t *testing.T) {
	...
	bot.Handle("/global", func(c tb.Context) error {
		...
		text, err := botpkg.SystemCompletion(ctx, client, botpkg.GlobalDigestPrompt, "gpt-4.1")
		if err != nil {
			return c.Send("OpenAI error")
		}
		return c.Send(text)
