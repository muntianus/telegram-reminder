...
Ты — эксперт по криптовалютам. Используй веб-поиск для анализа СВЕЖИХ НОВОСТЕЙ ЗА ПОСЛЕДНИЕ 24 ЧАСА.
...
🔍 ВЕБ-ПОИСК: Найди СВЕЖИЕ НОВОСТИ ЗА ПОСЛЕДНИЕ 24 ЧАСА по запросам:
- "bitcoin news today"
...
ВАЖНО: Используй веб-поиск для получения СВЕЖИХ НОВОСТЕЙ ЗА ПОСЛЕДНИЕ 24 ЧАСА и включай конкретные ссылки на актуальные статьи.
...
Составь детальный криптовалютный дайджест на русском для Telegram с СВЕЖИМИ НОВОСТЯМИ ЗА ПОСЛЕДНИЕ 24 ЧАСА.
`
...
Ты — эксперт по технологиям и стартапам. Используй веб-поиск для анализа СВЕЖИХ НОВОСТЕЙ ЗА ПОСЛЕДНИЕ 24 ЧАСА.
